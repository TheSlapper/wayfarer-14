using Content.Shared._Goobstation.SlotMachine.ClawGame; // Wayfarer: Component stays in Content.Shared._Goobstation while this system moved to Server, same reason as SlotMachineSystem
...
namespace Content.Server._Goobstation.SlotMachine.ClawGame;
...
public sealed class ClawMachineSystem : EntitySystem
{
    ...
    private void OnSlotMachineDoAfter(EntityUid uid, ClawMachineComponent comp, ClawGameDoAfterEvent args)
    {
        ...
        // Wayfarer: Lose buzz removed, the fail popup above is the only feedback
